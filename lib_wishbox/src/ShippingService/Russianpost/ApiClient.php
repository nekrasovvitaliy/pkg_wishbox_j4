...
class ApiClient
{
	 ...
	 * @param   string   $orderNum        Order num
	 * @param   string   $placeTo         Place to
	 * @param   string   $postofficeCode  Postoffice code
	 * @param   string   $regionTo        Region to
	 * @param   string   $streetTo        Street to
	 * @param   integer  $telAddress      Tel address
	 *
	...
	): ?int
	{
		...
		/**
		 * Recipient address type (обязательный)
		 * Valid values:
